...
export type DeserializeOptions = AcornOptions & { ts: Parameters<typeof tsPlugin>[0] }
...
export const deserialize = async <Res extends JSData = JSData>(
	...
	return acorn.Parser.extend( tsPlugin( options?.ts ) ).parse( code, {
		ecmaVersion : 'latest',
		sourceType  : 'module',
		...options,
	} ) as Res
 ...
 * @returns {Promise<string>}            - Generated Typescript source code
 * @example
